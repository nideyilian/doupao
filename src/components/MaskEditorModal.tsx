  ...
  return (
    <>
      <div
        ...
        className="ds-modal-layer fixed inset-0 flex flex-col bg-ds-surface animate-modal-in motion-reduce:animate-none"
      >
        {/* Header */}
        <div className="flex-none flex items-center justify-between px-4 py-3 border-b border-ds-border bg-ds-raised z-20">
          <div className="flex items-center gap-3">
            <button
              onClick={close}
              disabled={isSaving}
              className="p-2 -ml-2 text-ds-muted hover:bg-ds-subtle rounded-lg dark:text-ds-muted dark:hover:bg-ds-subtle transition"
              title="取消"
            >
            ...
            <div className="relative flex items-center gap-1.5">
              <h2 className="text-sm font-medium text-ds-text dark:text-ds-text-subtle" id="mask-editor-title">
                编辑遮罩
              </h2>
              <button
                type="button"
                ...
                className="flex h-6 w-6 items-center justify-center rounded-full text-ds-muted transition hover:bg-ds-subtle hover:text-ds-muted dark:text-ds-muted dark:hover:bg-ds-subtle dark:hover:text-ds-text"
                aria-label="遮罩编辑说明"
              >
              ...
              {showMaskInfo && (
                <div className="absolute left-0 top-full mt-2 w-64 rounded-ds-lg border border-ds-border/80 bg-ds-surface px-3 py-2 text-xs leading-5 text-ds-muted shadow-lg dark:border-ds-border dark:bg-ds-scrim dark:text-ds-muted">
                  <div className="absolute -top-1.5 left-16 h-3 w-3 rotate-45 border-l border-t border-ds-border/80 bg-ds-surface dark:border-ds-border dark:bg-ds-scrim" />
          ...
          <div className="flex items-center gap-2">
            {maskDraft?.targetImageId === imageId && (
              <button
                ...
                className="flex h-ds-control-sm items-center gap-1.5 px-4 text-sm font-medium text-ds-text-inverse bg-ds-danger hover:bg-ds-danger-hover rounded-lg transition"
              >
                移除遮罩
              </button>
            )}
            <button
              ...
              className="flex h-ds-control-sm items-center gap-1.5 px-4 text-sm font-medium text-ds-text-inverse bg-ds-primary hover:bg-ds-primary-hover rounded-lg disabled:opacity-50 transition"
            >
              {isSaving ? '保存中...' : '保存'}
            </button>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-4 px-2 sm:px-3 py-1.5 sm:py-2 bg-[hsl(var(--ds-color-surface-raised)/0.95)] dark:bg-[hsl(var(--ds-color-surface-raised)/0.95)] backdrop-blur-md border border-[hsl(var(--ds-color-border)/0.8)] rounded-ds-xl sm:rounded-[1.25rem] shadow-ds-lg pointer-events-auto">
            <div className="flex items-center gap-1.5 sm:gap-3">
              <div className="flex items-center bg-ds-surface/80 dark:bg-ds-surface-subtle/80 p-1 rounded-ds-lg sm:rounded-[14px]">
                ...
                <button
                  className={`p-2 sm:p-2.5 rounded-lg sm:rounded-ds-lg transition ${tool === 'eraser' ? 'bg-ds-surface shadow-sm text-ds-primary dark:bg-ds-surface-subtle dark:text-ds-primary dark:shadow-none' : 'text-ds-muted hover:text-ds-text dark:text-ds-text-subtle dark:hover:text-ds-text'}`}
              ...
              <div ref={brushSizeControlRef} className="relative flex items-center justify-center">
                <button
                  ...
                  className={`flex items-center justify-center w-ds-control-lg h-ds-control-lg sm:w-[46px] sm:h-[46px] rounded-ds-lg sm:rounded-[14px] transition border ${showBrushControls ? 'bg-ds-primary-subtle border-ds-primary/35 text-ds-primary dark:bg-ds-surface-subtle dark:border-ds-border-strong dark:text-ds-primary' : 'bg-ds-surface border-ds-border/80 text-ds-text hover:bg-ds-subtle dark:bg-transparent dark:border-ds-surface-subtle dark:text-ds-text dark:hover:border-ds-border-strong'}`}
                  disabled={!isReady || isSaving}
                  title="调节笔刷大小"
                >
            ...
            <div className="flex items-center gap-0.5 sm:gap-2 sm:ml-1">
              <button
                onClick={handleUndo}
                disabled={!canUndo}
                className="p-2 sm:p-2.5 text-ds-muted hover:bg-ds-subtle rounded-lg sm:rounded-ds-lg disabled:opacity-30 dark:text-ds-text-subtle dark:hover:bg-ds-surface dark:hover:text-ds-text transition"
                title="撤销"
              >
                <svg
                  className="w-5 h-5"
              ...
              <div className="w-px h-4 sm:h-5 bg-ds-subtle dark:bg-ds-border mx-1"></div>
              <button
